...
│                               ⚠ 真品判据：**1 500 654 字节 / 29 310 行**（`sha1 e3a3797ca4f0…`）。
...
### 编写器专项：`G:\saki\_verify\`（16 个，共 2 277 条）
...
1. **改完必须跑全量 8 层**（再加上 `_verify/` 那 16 套，共 2 277 条）。这套验证不是装饰，历史上有多次「改一处碎三处」都是它抓出来的。
